    ...
    styleOverrides: {
      root: ({ theme }) => ({
        ...
        ...theme.applyStyles('dark', {
          ...
          backgroundColor: (theme.vars || theme).palette.background.paper,
          boxShadow: `inset 0 1px 0 1px ${alpha(tasman[700], 0.15)}, inset 0 -1px 0 1px hsla(220, 0%, 0%, 0.7)`,
          '&:hover': {
            borderColor: alpha(tasman[700], 0.7),
            backgroundColor: (theme.vars || theme).palette.background.paper,
            boxShadow: 'none',
          },
          [`&.${selectClasses.focused}`]: {
            outlineOffset: 0,
            borderColor: tasman[900],
          },
          '&:before, &:after': {
            display: 'none',
          },
