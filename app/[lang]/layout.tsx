...
import { getMainMenu, getGlobalCTA, getActiveLanguages } from "@/lib/wordpress";
...
export default async function RootLayout({
  ...
  const [menuItems, cta, wpLanguages] = await Promise.all([
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head />
      <body className={cn("min-h-dvh font-sans antialiased", font.variable)}>
        
          <AppTheme>
          <SwiperStyles />
          <AppNav menuItems={menuItems} cta={cta} languages={wpLanguages}/>
          {/* <Nav /> */}
          {children}
          <Footer />
          </AppTheme>
